...
function make_xlsx_lib(e) {
  ...
  function h(e) {
    var r = [];
    for (var t = 0; t < e.length >> 1; ++t)
      r[t] = String.fromCharCode(e[2 * t] + (e[2 * t + 1] << 8));
    return r.join("");
  }
  function d(e) {
    var r = [];
  ...
  function g(e) {
    ...
    p = function (e) {
      if (e.charCodeAt(0) === 255 && e.charCodeAt(1) === 254) {
        return a.utils.decode(1200, f(e.slice(2)));
      }
      return e;
    };
    m = function n(e) {
  ...
  function O(e) {
    if (typeof ArrayBuffer === "undefined") return D(e);
    ...
    if (r.indexOf("e") > -1) {
      ...
      t =
        t.indexOf(".") > -1
          ...
          : t.slice(0, 15) + xr("0", t.length - 15);
      return t + r.slice(r.indexOf("e"));
    }
    var a =
      r.indexOf(".") > -1
        ? r.slice(0, r.slice(0, 2) == "0." ? 17 : 16)
        : r.slice(0, 15) + xr("0", r.length - 15);
    return Number(a);
  }
  function ae(e, r, t) {
    ...
    switch (e) {
      ...
      case 90:
        switch (r) {
          ...
          case "[ss]":
            o =
              ((t.D * 24 + t.H) * 60 + t.M) * 60 +
              (a == 0 ? Math.round(t.S + t.u) : t.S);
            break;
          default:
  ...
  function be(e, r, t) {
    ...
    return (
      ...
      " " +
      (s === 0
        ? xr(" ", e[1].length + 1 + e[4].length)
        : W(s, e[1].length) + e[2] + "/" + e[3] + z(l, e[4].length))
    );
  }
  function we(e, r, t) {
  ...
  function Ee(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + Ee(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var i,
      s,
      l,
    ...
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + Ee(e, r, -t)
        : he("" + (Math.floor(t) + Ae(t, i[1].length))) +
            "." +
            z(_e(t, i[1].length), i[1].length);
    }
    ...
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      ...
      s = 0;
      return U(
        U(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
    ...
    if ((i = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      n += f + i[2] + "/" + i[3];
      f = j(l[2], s);
      if (f.length < i[4].length)
        f = Se(i[4].substr(i[4].length - f.length)) + f;
      n += f;
      return n;
    }
    if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      return (
        ...
        " " +
        (l[1]
          ? W(l[1], s) + i[2] + "/" + i[3] + j(l[2], s)
          : xr(" ", 2 * s + 1 + i[2].length + i[3].length))
      );
    }
    if ((i = r.match(/^[#0?]+$/))) {
      n = G(t, 0);
  ...
  function Me(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + Me(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var i,
      s,
      l,
    ...
    switch (r) {
      ...
      default:
        if (r.match(/\.[0#?]*$/))
          return (
            Me(e, r.slice(0, r.lastIndexOf(".")), t) +
            Se(r.slice(r.lastIndexOf(".")))
          );
    }
    throw new Error("unsupported format |" + r + "|");
  }
      ...
      switch ((l = e.charAt(s))) {
        ...
        case "ä¸Š":
          ...
          if (e.substr(s, 3).toUpperCase() === "A/P") {
            ...
            if (c != null) m.v = c.H >= 12 ? "ä¸‹åˆ" : "ä¸Šåˆ";
            m.t = "T";
            s += 5;
            h = "h";
          } else {
        ...
        case "$":
          ...
          break;
        default:
          if (",$-+/():!^&'~{}<>=â‚¬acfijklopqrtuvwxzP".indexOf(l) === -1)
            throw new Error("unrecognized character " + l + " in " + e);
          n[n.length] = { t: "t", v: l };
          ++s;
          break;
      ...
      if (_ === n.length && C.indexOf("E") === -1) {
        ...
        for (s = _; s >= 0; --s) {
          ...
          for (; f >= 0; --f) {
            if (
              y >= 0 &&
              (n[s].v.charAt(f) === "0" || n[s].v.charAt(f) === "#")
            )
              x = C.charAt(y--) + x;
          }
          n[s].v = x;
        ...
        for (s = _; s < n.length; ++s) {
          if (n[s] == null || ("n?(".indexOf(n[s].t) === -1 && s !== _))
            continue;
  ...
  function Je(e, r, t) {
    var a = -1,
      ...
      l = -1,
      o = -1;
    (r.match(Ge) || []).forEach(function (e, r) {
  ...
  var qe = (function () {
    ...
    function a(e) {
      ...
      for (a = 1; a != 16; ++a)
        i[a - 1] =
          typeof Int32Array !== "undefined" && typeof n.subarray == "function"
  ...
  var Qe = (function Lc() {
    ...
    function c(e, r) {
      ...
      if (r && r.raw) F.raw = { header: w, sectors: S };
      return F;
    }
    function f(e) {
      ...
      for (; u < f.length; u += 128) {
        ...
        if (g.type === 5) {
          ...
          if (r[g.start] === undefined)
            r[g.start] = v(t, g.start, r.fat_addrs, r.ssz);
    ...
    function O(e, n) {
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        if (l === 0) {
          ...
          p.C = f >= h.length ? -1 : f;
          for (f = l + 1; f < h.length; ++f)
            if (t(e.FullPaths[f]) == t(m)) break;
          p.R = f >= h.length ? -1 : f;
          p.type = 1;
        } else {
    ...
    function M(e, r) {
      ...
      for (i = 0; i < a[4] << 2; ++i) {
        ...
        if (h.length > 32) {
          console.error(
            "Name " + h + " will be truncated to " + h.slice(0, 32),
          );
          h = h.slice(0, 32);
        }
        c = 2 * (h.length + 1);
    ...
    function N(e, r) {
      ...
      for (s = 0; s < t.length; ++s) {
        if ((l ? t[s].replace(B, "!") : t[s]).replace(L, "") == i)
          return e.FileIndex[s];
        if ((l ? a[s].replace(B, "!") : a[s]).replace(L, "") == i)
          return e.FileIndex[s];
      }
      return null;
    }
    ...
    function Oe(e, r) {
      ...
      var l = t.length - 4;
      while (
        (t[l] != 80 || t[l + 1] != 75 || t[l + 2] != 5 || t[l + 3] != 6) &&
        l >= 0
      )
        --l;
      t.l = l + 4;
    ...
    function $e(e, r) {
      ...
      for (var o = 1; o < e.FullPaths.length; ++o) {
        ...
        var u = 0,
          ...
          d = 0;
        for (var p = 0; p <= h; ++p)
          if ((d = f.charCodeAt(p)) >= 32 && d < 128) ++u;
        var m = u >= (h * 4) / 5;
        n.push(a);
        n.push("Content-Location: " + (t.root || "file:///C:/SheetJS/") + s);
        n.push(
          "Content-Transfer-Encoding: " + (m ? "quoted-printable" : "base64"),
        );
  ...
  function ar(e, r, t) {
    if (typeof er !== "undefined" && er.writeFileSync)
      return t ? er.writeFileSync(e, r, t) : er.writeFileSync(e, r);
    ...
    if (typeof Blob !== "undefined") {
      var n = new Blob([tr(a)], { type: "application/octet-stream" });
      ...
      if (
        ...
        var l =
          "data:application/octet-stream;base64," + S(new Uint8Array(tr(a)));
        return chrome.downloads.download({ url: l, filename: e, saveAs: true });
      }
    }
    if (
      typeof $ !== "undefined" &&
  ...
  function wr(e, r) {
    ...
    if (t)
      return new Date(
        (r ? hr : ur) +
          ((parseInt(t[1], 10) * 60 + parseInt(t[2], 10)) * 60 +
            (t[3] ? parseInt(t[3].slice(1), 10) : 0)) *
            1e3 +
          (t[4] ? parseInt((t[4] + "000").slice(1, 4), 10) : 0),
      );
    t = e.match(gr);
    ...
    if (t)
      return new Date(
        Date.UTC(
          ...
          +t[4],
          +t[5],
          (t[6] && parseInt(t[6].slice(1), 10)) || 0,
          (t[7] && parseInt(t[7].slice(1), 10)) || 0,
        ),
      );
    var a = new Date(e);
    return a;
  ...
  function kr(e, r) {
    if (_ && Buffer.isBuffer(e)) {
      if (r && T) {
        ...
        if (e[1] == 254 && e[2] == 255)
          return yt(d(e.slice(2).toString("binary")));
      }
    ...
    if (typeof TextDecoder !== "undefined")
      try {
        ...
        return new TextDecoder("latin1")
          .decode(e)
          .replace(
            /[â‚¬â€šÆ’â€žâ€¦â€ â€¡Ë†â€°Å â€¹Å’Å½â€˜â€™â€œâ€â€¢â€“â€”Ëœâ„¢Å¡â€ºÅ“Å¾Å¸]/g,
            function (e) {
              return t[e] || e;
            },
          );
    ...
    var n = [],
      i = 0;
    try {
      for (i = 0; i < e.length - 65536; i += 65536)
        n.push(String.fromCharCode.apply(0, e.slice(i, i + 65536)));
      n.push(String.fromCharCode.apply(0, e.slice(i)));
    } catch (a) {
      try {
        for (; i < e.length - 16384; i += 16384)
          n.push(String.fromCharCode.apply(0, e.slice(i, i + 16384)));
        n.push(String.fromCharCode.apply(0, e.slice(i)));
      } catch (a) {
  ...
  function yr(e) {
    ...
    var r = {};
    for (var t in e)
      if (Object.prototype.hasOwnProperty.call(e, t)) r[t] = yr(e[t]);
    return r;
  }
  function xr(e, r) {
    var t = "";
  ...
  function Pr(e) {
    ...
    if (e._data && e._data.getContent)
      return p(kr(Array.prototype.slice.call(e._data.getContent(), 0)));
    return null;
  }
  function Rr(e) {
    if (!e) return null;
  ...
  function ot(e) {
    ...
    return r
      ...
      .replace(lt, function (e) {
        return "_x" + ("000" + e.charCodeAt(0).toString(16)).slice(-4) + "_";
      });
  }
  function ct(e) {
    return ot(e).replace(/ /g, "_x0020_");
  }
  var ft = /[\u0000-\u001f]/g;
  function ut(e) {
    var r = e + "";
  ...
  var wt = "foo bar bazÃ¢Â˜ÂƒÃ°ÂŸÂÂ£";
  ...
  function Ot(e, r, t) {
    return (
      ...
      (t != null ? Dt(t) : "") +
      (r != null
        ? (r.match(Et) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e
        : "/") +
      ">"
    );
  }
  ...
  function Nt(e, r) {
    switch (typeof e) {
      case "string":
        var t = Ot("vt:lpwstr", ot(e));
        if (r) t = t.replace(/&quot;/g, "_x0022_");
        return t;
      case "number":
        return Ot((e | 0) == e ? "vt:i4" : "vt:r8", ot(String(e)));
      case "boolean":
        return Ot("vt:bool", e ? "true" : "false");
    }
    if (e instanceof Date) return Ot("vt:filetime", Mt(e));
    ...
    if (i === "dbcs") {
      ...
      if (typeof a !== "undefined" && t == 874) {
        ...
        if (o.length == n.length)
          for (l = 0; l < n.length; ++l)
            if (o[l] == 0 && n.charCodeAt(l) != 0) o[l] = 95;
        if (o.length == 2 * n.length)
          for (l = 0; l < n.length; ++l)
            if (o[2 * l] == 0 && o[2 * l + 1] == 0 && n.charCodeAt(l) != 0)
              o[2 * l] = 95;
        ...
        for (l = 0; l != n.length; ++l)
          this[this.l + l] = n.charCodeAt(l) & 255;
        s = n.length;
      }
    } else if (i === "hex") {
      for (; l < e; ++l) {
  ...
  function Fa(e, r) {
    ...
    var t = $a(e);
    if (!e.cRel && e.cRel != null) t = La(t);
    if (!e.rRel && e.rRel != null) t = Na(t);
    return t;
  }
  function Da(e, r) {
    if (e.s.r == 0 && !e.s.rRel) {
    ...
    return Fa(e.s, r.biff) + ":" + Fa(e.e, r.biff);
  }
  function Oa(e) {
  ...
  function Wa(e) {
    var r = e.indexOf(":");
    if (r == -1) return { s: za(e), e: za(e) };
    return { s: za(e.slice(0, r)), e: za(e.slice(r + 1)) };
  }
  function ja(e, r) {
  ...
  function Ha(e) {
    var r = Wa(e);
    return (
      "$" + Ra(r.s.c) + "$" + Ma(r.s.r) + ":$" + Ra(r.e.c) + "$" + Ma(r.e.r)
    );
  }
  function Va(e, r) {
  ...
  var dn = {
    ...
    11: { n: "ScaleCrop", t: rn },
    12: { n: "HeadingPairs", t: on },
    13: { n: "TitlesOfParts", t: cn },
    14: { n: "Manager", t: fn },
    15: { n: "Company", t: fn },
    ...
    (e.match(qr) || []).forEach(function (e) {
      ...
      switch (a[0].replace(Qr, "<")) {
        ...
        case "<Default":
          ...
          break;
        case "<Override":
          if (r[Sn[a.ContentType]] !== undefined)
            r[Sn[a.ContentType]].push(a.PartName);
          break;
      }
    });
    ...
    if (!t) {
      ...
      n = n.concat(
        [
          ...
          return Ot("Default", null, { Extension: e[0], ContentType: e[1] });
        }),
      );
    }
    var s = function (t) {
      if (e[t] && e[t].length > 0) {
        i = e[t][0];
        n[n.length] = Ot("Override", null, {
          PartName: (i[0] == "/" ? "" : "/") + i,
          ContentType: Cn[t][r.bookType] || Cn[t]["xlsx"],
        });
      }
    };
    var l = function (t) {
  ...
  function On(e) {
    var r = [Yr, Ot("Relationships", null, { xmlns: Rt.RELS })];
    ir(e["!id"]).forEach(function (t) {
      r[r.length] = Ot("Relationship", null, e["!id"][t]);
    });
    if (r.length > 2) {
  ...
  function Mn(e, r, t, a, n, i) {
    ...
    n.Target = t;
    if (i) n.TargetMode = i;
    else if ([En.HLINK, En.XPATH, En.XMISS].indexOf(n.Type) > -1)
  ...
  function Bn(e) {
    ...
    for (var t = 0; t != e.length; ++t) {
      r.push(Rn(e[t][0], e[t][1]));
      r.push(Ln("", e[t][0]));
    }
    r.push(Rn("", "Document", "pkg"));
    r.push("</rdf:RDF>");
    return r.join("");
  }
  function Un(r, t) {
  ...
  function jn(e, r, t, a, n) {
    if (n[e] != null || r == null || r === "") return;
    n[e] = r;
    r = ot(r);
    a[a.length] = t ? Ot(e, r, t) : Ft(e, r);
  }
  function Hn(e, r) {
    var t = r || {};
    var a = [
        Yr,
        Ot("cp:coreProperties", null, {
          "xmlns:cp": Rt.CORE_PROPS,
          "xmlns:dc": Rt.dc,
          "xmlns:dcterms": Rt.dcterms,
          "xmlns:dcmitype": Rt.dcmitype,
          "xmlns:xsi": Rt.xsi,
        }),
      ],
      n = {};
  ...
  function Yn(e, r, t) {
    ...
    if (a.HeadingPairs && a.TitlesOfParts)
      Gn(a.HeadingPairs, a.TitlesOfParts, r, t);
    return r;
  }
  function Jn(e) {
    var r = [],
  ...
  function qn(e) {
    var r = [
      Yr,
      Ot("Properties", null, { xmlns: Rt.CUST_PROPS, "xmlns:vt": Rt.vt }),
    ];
    if (!e) return r.join("");
    var t = 1;
    ir(e).forEach(function a(n) {
      ++t;
      r[r.length] = Ot("property", Nt(e[n], true), {
  ...
  var ei = (function () {
    ...
    function i(r, t) {
      ...
      while (i.l < v && i[i.l] != 13) {
        ...
        m.name = (
          typeof a !== "undefined"
            ? a.utils.decode(d, i.slice(i.l, i.l + g))
            : M(i.slice(i.l, i.l + g))
        ).replace(/[\u0000\r\n].*$/g, "");
        i.l += g;
      ...
      while (f-- > 0) {
        ...
        for (w = 0; w != p.length; ++w) {
          ...
          switch (p[w].type) {
            ...
            case "Y":
              n[b][w] =
                k._R(4, "i") / 1e4 + (k._R(4, "i") / 1e4) * Math.pow(2, 32);
              break;
            case "O":
              n[b][w] = -k._R(-8, "f");
              break;
    ...
    function f(i, s) {
      ...
      var u = _a();
      var h = dc(i, { header: 1, raw: true, cellDates: true });
      var d = h[0],
        p = h.slice(1),
        m = i["!cols"] || [];
      var v = 0,
      ...
      for (v = 0; v < d.length; ++v) {
        ...
        if (typeof d[v] !== "string")
          throw new Error(
            "DBF Invalid column name " + d[v] + " |" + typeof d[v] + "|",
          );
        if (d.indexOf(d[v]) !== v)
          for (g = 0; g < 1024; ++g)
            if (d.indexOf(d[v] + "_" + g) == -1) {
              d[v] += "_" + g;
              break;
            }
      }
      ...
      for (v = 0; v <= k.e.c - k.s.c; ++v) {
        ...
        for (g = 0; g < T.length; ++g) {
          ...
          A = Math.max(
            A,
            (typeof a !== "undefined" && typeof T[g] == "string"
              ? a.utils.encode(t, T[g])
              : String(T[g])
            ).length,
          );
          C = C && C != _ ? "C" : _;
      ...
      if (e[F] != +l.codepage) {
        if (l.codepage)
          console.error("DBF Unsupported codepage " + r + ", using 1252");
        r = 1252;
      }
  ...
  var ri = (function () {
        ...
        if (x.length > 0)
          switch (C) {
            ...
            case "NN":
              {
                ...
                for (u = 1; u < S.length; ++u)
                  switch (S[u].charAt(0)) {
                    ...
                    case "E":
                      T.Ref =
                        ((t && t.sheet) || "Sheet1") + "!" + Os(S[u].slice(1));
                      break;
                  }
            ...
            case "C":
                ...
                switch (S[u].charAt(0)) {
                  ...
                  case "K":
                    ...
                    if (
                      ...
                      _ = a.utils.decode(t.codepage, _);
                    E = true;
                    break;
                  case "E":
                    O = true;
                    I = Os(S[u].slice(1), { r: l, c: c });
                    break;
                  case "S":
                    D = true;
                    break;
              ...
              if (E) {
                if (!h[l][c]) h[l][c] = { t: P, v: _ };
                else {
                  h[l][c].t = P;
                  h[l][c].v = _;
                }
                if (p) h[l][c].z = p;
                if (t.cellText !== false && p)
                  h[l][c].w = $e(h[l][c].z, h[l][c].v, {
              ...
              if (D) {
                ...
                I = Ps(L[1], { r: l - M, c: c - N });
              }
              if (I) {
                if (!h[l][c]) h[l][c] = { t: "n", f: I };
                else h[l][c].f = I;
              }
              if (R) {
                if (!h[l][c]) h[l][c] = { t: "z" };
                h[l][c].c = [{ a: "SheetJSYLK", t: R }];
              }
              break;
            case "F":
              var B = 0;
    ...
    return { to_workbook: f, from_sheet: m };
  })();
  var ti = (function () {
    function e(e, t) {
      switch (t.type) {
  ...
  var ai = (function () {
    ...
    function t(r, t) {
      ...
      for (; s !== a.length; ++s) {
        ...
        var c = za(o[1]);
        if (l.length <= c.r)
          for (n = l.length; n <= c.r; ++n) if (!l[n]) l[n] = [];
        n = c.r;
        i = c.c;
        switch (o[2]) {
          case "t":
  ...
  var ni = (function () {
    ...
    function o(e, r) {
      ...
      if (t.slice(0, 19) == "socialcalc:version:")
        return ai.to_sheet(r.type == "string" ? t : kt(t), r);
      return l(t, r);
    }
    function c(e, r) {
      return Ja(o(e, r), r);
  ...
  function hi(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      a.t = it(
        kt(e.slice(e.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0] || ""),
        true,
      );
      a.r = kt(e);
      if (t) a.h = ut(a.t);
      ...
      a.r = kt(e);
      a.t = it(
        kt((e.replace(ui, "").match(ci) || []).join("").replace(qr, "")),
        true,
      );
      if (t) a.h = oi(li(a.r));
    }
  ...
  function bi(e, r) {
    ...
    for (var a = 0; a != e.length; ++a) {
      ...
      if (n.r) i += n.r;
        ...
        if (n.t.match(gi)) i += ' xml:space="preserve"';
        i += ">" + ot(n.t) + "</t>";
      }
      i += "</si>";
      t[t.length] = i;
  ...
  function Ui(e, r, t, a) {
    ...
    var n = {};
    var i = false;
    (e[0].match(qr) || []).forEach(function (e) {
      var t = rt(e);
      switch (tt(t[0])) {
        case "<borders":
        case "<borders>":
  ...
  function ji(e) {
    ...
    r[r.length] = "</numFmts>";
    r[0] = Ot("numFmts", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
    ...
    (e[0].match(qr) || []).forEach(function (e) {
      ...
      switch (tt(i[0])) {
        ...
        case "<xf>":
          a = i;
          delete a[0];
          for (s = 0; s < Hi.length; ++s)
            if (a[Hi[s]]) a[Hi[s]] = parseInt(a[Hi[s]], 10);
  ...
  function Gi(e) {
    var r = [];
    r[r.length] = Ot("cellXfs", null);
    e.forEach(function (e) {
      r[r.length] = Ot("xf", null, e);
    });
    r[r.length] = "</cellXfs>";
    if (r.length === 2) return "";
    r[0] = Ot("cellXfs", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
  var Yi = (function Jc() {
  ...
  function Ji(e, r) {
    var t = [Yr, Ot("styleSheet", null, { xmlns: Lt[0], "xmlns:vt": Rt.vt })],
      a;
    if (e.SSF && (a = ji(e.SSF)) != null) t[t.length] = a;
    t[t.length] =
    ...
    if ((a = Gi(r.cellXfs))) t[t.length] = a;
    t[t.length] =
      ...
      switch (tt(r[0])) {
        ...
        case "<futureMetadata":
          for (var l = 0; l < a.Types.length; ++l)
            if (a.Types[l].name == r.name) s = a.Types[l];
          break;
        case "</futureMetadata>":
          break;
        case "<bk>":
  ...
  function ds(e, r, t) {
    var a = 0;
    (e.match(hs) || []).forEach(function (e) {
      var n = "";
      var i = true;
      var s = -1;
      var l = -1,
        o = -1;
      e.replace(qr, function (r, t) {
        var a = rt(r);
        switch (tt(a[0])) {
          case "<ClientData":
      ...
      switch (n) {
        case "Note":
          var c = yc(r, l >= 0 && o >= 0 ? $a({ r: l, c: o }) : t[a].ref);
          if (c.c) {
            c.c.hidden = i;
          }
          ++a;
  ...
  function ps(e, r, t) {
    ...
    var i = [
      ...
      Ot("o:shapelayout", Ot("o:idmap", null, { "v:ext": "edit", data: e }), {
        "v:ext": "edit",
      }),
    ];
    var s = 65536 * e;
    ...
    if (l.length > 0)
      i.push(
        Ot(
          "v:shapetype",
          [
            Ot("v:stroke", null, { joinstyle: "miter" }),
            Ot("v:path", null, {
              gradientshapeok: "t",
              "o:connecttype": "rect",
            }),
  ...
  function ms(e, r, t) {
    var a = za(e[0]);
    var n = { color2: "#BEFF82", type: "gradient" };
    if (n.type == "gradient") n.angle = "-180";
    var i =
      n.type == "gradient"
        ? Ot("o:fill", null, { type: "gradientUnscaled", "v:ext": "view" })
        : null;
    var s = Ot("v:fill", i, n);
    var l = { on: "t", obscured: "t" };
    return [
      "<v:shape" +
        Dt({
          id: "_x0000_s" + r,
      ...
      s,
      Ot("v:shadow", null, l),
      Ot("v:path", null, { "o:connecttype": "none" }),
  ...
  function bs(e) {
    var r = [Yr, Ot("comments", null, { xmlns: Lt[0] })];
    var t = [];
    r.push("<authors>");
    e.forEach(function (e) {
    ...
    e.forEach(function (e) {
      ...
      e[1].forEach(function (e) {
        if (e.a) a = t.indexOf(ot(e.a));
        if (e.T) ++i;
        n.push(e.t == null ? "" : ot(e.t));
      });
      if (i === 0) {
  ...
  function ks(e, r, t) {
    var a = [
      Yr,
      Ot("ThreadedComments", null, { xmlns: Rt.TCMNT }).replace(/[\/]>/, ">"),
    ];
    e.forEach(function (e) {
      var n = "";
      (e[1] || []).forEach(function (i, s) {
        ...
        if (i.a)
          l.personId =
            ...
            "}";
        a.push(Ot("threadedComment", Ft("text", i.t || ""), l));
      });
    });
  ...
  function xs(e) {
    var r = [
      Yr,
      Ot("personList", null, { xmlns: Rt.TCMNT, "xmlns:x": Lt[0] }).replace(
        /[\/]>/,
        ">",
      ),
    ];
  ...
  var As = ["xlsb", "xlsm", "xlam", "biff8", "xla"];
  function Ts() {
    return { "!type": "dialog" };
  }
  function Es() {
  ...
  var Is = (function () {
    return function e(r, t) {
      return r.replace(Ms, function (e, r, a, n, i, s) {
        var l = Pa(n) - (a ? 0 : t.c);
        var o = Oa(s) - (i ? 0 : t.r);
        var c = i == "$" ? o + 1 : o == 0 ? "" : "[" + o + "]";
        var f = a == "$" ? l + 1 : l == 0 ? "" : "[" + l + "]";
  ...
  function Ps(e, r) {
    return e.replace(Ms, function (e, t, a, n, i, s) {
      return (
        t +
        (a == "$" ? a + n : Ra(Pa(n) + r.c)) +
        (i == "$" ? i + s : Ma(Oa(s) + r.r))
  ...
  function zs(e) {
    var r = "of:=" + e.replace(Ms, "$1[.$2$3$4$5]").replace(/\]:\[/g, ":");
  ...
  var js = {};
  var Hs = {};
  var Vs = typeof Map !== "undefined";
  function Xs(e, r, t) {
    var a = 0,
      n = e.length;
    if (t) {
      if (Vs ? t.has(r) : Object.prototype.hasOwnProperty.call(t, r)) {
        var i = Vs ? t.get(r) : t[r];
        for (; a < i.length; ++a) {
          if (e[i[a]].t === r) {
            e.Count++;
            return i[a];
  ...
  function cl(e, r, t, a, n, i, s) {
    ...
    var d = (c.match(/<(?:\w*:)?dimension/) || { index: -1 }).index;
    if (d > 0) {
    ...
    if (y)
      for (d = 0; d != y.length; ++d)
        k[d] = Xa(y[d].slice(y[d].indexOf('"') + 1));
    var x = f.match(rl);
    if (x) gl(l, x, a);
    var S = f.match(il);
  ...
  function dl(e, r, t, a, n) {
    ...
    if (e && e["!outline"]) {
      ...
      l = (l || "") + Ot("outlinePr", null, f);
    }
    if (!i && !l) return;
    n[n.length] = Ot("sheetPr", l, s);
  }
  ...
  function vl(e) {
    ...
    if (e.password)
      r.password = crypto_CreatePasswordVerifier_Method1(e.password)
        .toString(16)
        .toUpperCase();
    return Ot("sheetProtection", null, r);
  }
  function gl(e, r, t) {
    var a = e["!data"] != null;
    for (var n = 0; n != r.length; ++n) {
      ...
      for (var o = l.s.r; o <= l.e.r; ++o)
        for (var c = l.s.c; c <= l.e.c; ++c) {
          ...
          if (a) {
            ...
            if (!e["!data"][o][c]) e["!data"][o][c] = { t: "z", v: undefined };
            e["!data"][o][c].l = i;
          } else {
  ...
  function Sl(e, r, t, a) {
    var n = typeof e.ref == "string" ? e.ref : ja(e.ref);
    ...
    return Ot("autoFilter", null, { ref: n });
  }
  var Cl = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/?>/g;
  function _l(e, r) {
    if (!r.Views) r.Views = [{}];
    (e.match(Cl) || []).forEach(function (e, t) {
      var a = rt(e);
  ...
  function Al(e, r, t, a) {
    ...
    return Ot("sheetViews", Ot("sheetView", null, n), {});
  }
  function Tl(e, r, t, a, n, i, s) {
    if (e.c) t["!comments"].push([r, e.c]);
    if (
      (e.v === undefined || (e.t === "z" && !(a || {}).sheetStubs)) &&
      typeof e.f !== "string" &&
      typeof e.z == "undefined"
    )
      return "";
    var l = "";
    var o = e.t,
      ...
      switch (e.t) {
        ...
        case "d":
          if (a && a.cellDates) {
            var f = wr(e.v, s);
            l = f.toISOString();
            if (f.getUTCFullYear() < 1900)
              l = l.slice(l.indexOf("T") + 1).replace("Z", "");
          } else {
            e = yr(e);
            e.t = "n";
            l = "" + (e.v = dr(wr(e.v, s), s));
    ...
    var u = e.t == "z" || e.v == null ? "" : Ft("v", ot(l)),
      h = { r: r };
    var d = Js(a.cellXfs, e, a);
    if (d !== 0) h.s = d;
    switch (e.t) {
      case "n":
        break;
      ...
      default:
        ...
        if (a && a.bookSST) {
          u = Ft("v", "" + Xs(a.Strings, e.v, a.revStrings));
          h.t = "s";
          break;
        } else h.t = "str";
        break;
    ...
    return function l(o, c, f, u, h, d, p) {
      ...
      for (var $ = o.split(r), W = 0, j = $.length; W != j; ++W) {
        ...
        for (m = 0; m != g.length; ++m) {
          ...
          for (k = 0; k != v.length; ++k) if (v.charCodeAt(k) === 62) break;
          ++k;
          C = rt(v.slice(0, k), true);
          if (!C.r) C.r = $a({ r: _ - 1, c: A });
          x = v.slice(k);
          S = { t: "" };
          ...
          if (f.cellFormula) {
            ...
            for (k = 0; k < N.length; ++k)
              if (Y.r >= N[k][0].s.r && Y.r <= N[k][0].e.r)
                if (Y.c >= N[k][0].s.c && Y.c <= N[k][0].e.c) S.F = N[k][1];
          }
  ...
  function Fl(e, r, t, a) {
    ...
    var m = { r: c },
      v,
      g = -1;
    var b = (((a || {}).Workbook || {}).WBProps || {}).date1904;
    for (h = s.s.c; h <= s.e.c; ++h) f[h] = Ra(h);
    for (u = s.s.r; u <= s.e.r; ++u) {
      i = [];
      c = Ma(u);
      for (h = s.s.c; h <= s.e.c; ++h) {
        o = f[h] + c;
        var w = p ? (e["!data"][u] || [])[h] : e[o];
        if (w === undefined) continue;
        if ((l = Tl(w, o, e, r, t, a, b)) != null) i.push(l);
      }
      if (i.length > 0 || (d && d[u])) {
        m = { r: c };
        if (d && d[u]) {
  ...
  function Dl(e, r, t, a) {
    var n = [Yr, Ot("worksheet", null, { xmlns: Lt[0], "xmlns:r": Rt.r })];
    ...
    var u = [];
    dl(o, t, e, r, n);
    n[n.length] = Ot("dimension", null, { ref: c });
    n[n.length] = Al(o, r, e, t);
    if (r.sheetFormat)
      n[n.length] = Ot("sheetFormatPr", null, {
    ...
    if (o["!links"].length > 0) {
      ...
      o["!links"].forEach(function (e) {
        ...
        if (e[1].Target.charAt(0) != "#") {
          p = Mn(a, -1, ot(e[1].Target).replace(/#.*$/, ""), En.HLINK);
          d["r:id"] = "rId" + p;
        }
        if ((h = e[1].Target.indexOf("#")) > -1)
          d.location = ot(e[1].Target.slice(h + 1));
        if (e[1].Tooltip) d.tooltip = ot(e[1].Tooltip);
        d.display = e[1].display;
        n[n.length] = Ot("hyperlink", null, d);
      });
      n[n.length] = "</hyperlinks>";
    }
    delete o["!links"];
    if (o["!margins"] != null) n[n.length] = wl(o["!margins"]);
    if (!r || r.ignoreEC || r.ignoreEC == void 0)
      n[n.length] = Ft(
        "ignoredErrors",
        Ot("ignoredError", null, { numberStoredAsText: 1, sqref: c }),
      );
    if (u.length > 0) {
      p = Mn(a, -1, "../drawings/drawing" + (e + 1) + ".xml", En.DRAW);
      n[n.length] = Ot("drawing", null, { "r:id": "rId" + p });
      o["!drawing"] = u;
    }
    if (o["!comments"].length > 0) {
      p = Mn(a, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", En.VML);
      n[n.length] = Ot("legacyDrawing", null, { "r:id": "rId" + p });
      o["!legacy"] = p;
    }
    if (n.length > 1) {
      ...
      function (e) {
        ...
        r[0].forEach(function (e, t) {
          if (s["!data"]) {
            ...
            s["!data"][t][l] = { t: "n", v: e, z: r[1] };
          } else s[c + Ma(t)] = { t: "n", v: e, z: r[1] };
          o = t;
        });
        if (f.e.r < o) f.e.r = o;
        ++l;
  ...
  function $l(e) {
    ...
    return mt(e.Workbook.WBProps.date1904) ? "true" : "false";
  }
  var Wl = ":][*?/\\".split("");
  function jl(e, r) {
    try {
  ...
  function Vl(e) {
    ...
    Hl(e.SheetNames, r, !!e.vbaraw);
    for (var t = 0; t < e.SheetNames.length; ++t)
      Ks(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
    e.SheetNames.forEach(function (r, t) {
      ...
      var i = Va(r) + "!" + Ha(a["!autofilter"].ref);
      if (n) n.Ref = i;
      else
  ...
  function Yl(e) {
    var r = [Yr];
    r[r.length] = Ot("workbook", null, { xmlns: Lt[0], "xmlns:r": Rt.r });
    ...
    r[r.length] = Ot("workbookPr", null, a);
    ...
    r[r.length] = "<sheets>";
    for (i = 0; i != e.SheetNames.length; ++i) {
      var s = { name: ot(e.SheetNames[i].slice(0, 31)) };
      s.sheetId = "" + (i + 1);
      s["r:id"] = "rId" + (i + 1);
      if (n[i])
        switch (n[i].Hidden) {
    ...
    if (t) {
      ...
      if (e.Workbook && e.Workbook.Names)
        e.Workbook.Names.forEach(function (e) {
          ...
          if (!e.Ref) return;
          r[r.length] = Ot("definedName", ot(e.Ref), t);
        });
      r[r.length] = "</definedNames>";
    }
    if (r.length > 2) {
  ...
  function so(e, r) {
    ...
    for (l = 0; l < c.length; ++l) {
      ...
      for (o = 0; o < w.length; ++o) {
        ...
        var y = k,
          x = 0;
        while (y.charAt(0) == "<" && (x = y.indexOf(">")) > -1)
          y = y.slice(x + 1);
        for (var S = 0; S < m.length; ++S) {
          var C = m[S];
          if (C.s.c == u && C.s.r < f && f <= C.e.r) {
            u = C.e.c + 1;
            S = -1;
          }
        }
        var _ = rt(k.slice(0, k.indexOf(">")));
        d = _.colspan ? +_.colspan : 1;
        if ((h = +_.rowspan) > 1 || d > 1)
          m.push({
            s: { r: f, c: u },
            e: { r: f + (h || 1) - 1, c: u + d - 1 },
          });
        ...
        var T = { t: "s", v: y };
        if (t.raw || !y.trim().length || A == "s") {
        } else if (y === "TRUE") T = { t: "b", v: true };
        else if (y === "FALSE") T = { t: "b", v: false };
        else if (!isNaN(Sr(y))) T = { t: "n", v: Sr(y) };
        else if (!isNaN(Or(y).getDate())) {
          T = { t: "d", v: wr(y) };
          if (t.UTC === false) T.v = Nr(T.v);
          if (!t.cellDates) T = { t: "n", v: dr(T.v) };
          T.z = t.dateNF || q[14];
        }
        if (T.cellText !== false) T.w = y;
        if (a) {
  ...
  function lo(e, r, t, a) {
    ...
    for (var o = r.s.c; o <= r.e.c; ++o) {
      ...
      var p =
        (d && d.v != null && (d.h || ut(d.w || (Ya(d), d.w) || ""))) || "";
      s = {};
      if (c > 1) s.rowspan = c;
      if (f > 1) s.colspan = f;
      if (a.editable) p = '<span contenteditable="true">' + p + "</span>";
        ...
        s["data-t"] = (d && d.t) || "z";
        if (d.v != null)
          s["data-v"] = d.v instanceof Date ? d.v.toISOString() : d.v;
        if (d.z != null) s["data-z"] = d.z;
        if (d.l && (d.l.Target || "#").charAt(0) != "#")
          p = '<a href="' + ut(d.l.Target) + '">' + p + "</a>";
      }
      s.id = (a.id || "sjs") + "-" + h;
      i.push(Ot("td", p, s));
    }
    ...
    for (; m < a.length && v < c; ++m) {
      ...
      for (g = b = 0; g < x.length; ++g) {
        ...
        if (
          F &&
          F.charAt(0) != "#" &&
          F.slice(0, 11).toLowerCase() != "javascript:"
        )
          T.l = { Target: F };
        if (i) {
          if (!e["!data"][v + s]) e["!data"][v + s] = [];
          e["!data"][v + s][b + l] = T;
        } else e[$a({ c: b + l, r: v + s })] = T;
    ...
    while ((i = Pt.exec(n))) {
      switch ((i[3] = i[3].replace(/_.*$/, ""))) {
        ...
        case "scientific-number":
          ...
          l +=
            "0." +
            xr("0", +c["min-decimal-places"] || +c["decimal-places"] || 2) +
            xr("?", +c["decimal-places"] - +c["min-decimal-places"] || 0) +
            "E" +
            (mt(c["forced-exponent-sign"]) ? "+" : "") +
            xr("0", +c["min-exponent-digits"] || 2);
          break;
        case "fraction":
          c = rt(i[0], false);
        ...
        case "currency-symbol":
          if (i[1] === "/") {
            l +=
              '"' +
              n.slice(u, Pt.lastIndex - i[0].length).replace(/"/g, '""') +
              '"';
          } else if (i[0].charAt(i[0].length - 2) !== "/") {
            u = Pt.lastIndex;
          } else l += "$";
        ...
        case "map":
          c = rt(i[0], false);
          if (it(c["condition"]) == "value()>=0")
            l = a[c["apply-style-name"]] + ";" + l;
          else
            console.error(
              "ODS number format may be incorrect: " + c["condition"],
            );
          break;
        case "number":
          if (i[1] === "/") break;
          ...
          if (+c["min-decimal-places"])
            o += xr("0", +c["min-decimal-places"] || 1);
          if (+c["decimal-places"] - (+c["min-decimal-places"] || 0))
            o += xr(
              "0",
              +c["decimal-places"] - (+c["min-decimal-places"] || 0),
            );
          l += o;
          break;
        case "embedded-text":
  ...
  function yo(e, r, t) {
    ...
    while ((v = Pt.exec(n)))
      switch ((v[3] = v[3].replace(/_.*$/, ""))) {
        ...
        case "è¡Œ":
          ...
          h = rt(v[0], false);
          if (h["è¡Œå·"]) T = h["è¡Œå·"] - 1;
          else if (T == -1) T = 0;
          B = +h["number-rows-repeated"] || 1;
          if (B < 10)
            for (Z = 0; Z < B; ++Z) if (D > 0) L[T + Z] = { level: D };
          E = -1;
          break;
        ...
        case "æ•°æ®":
          if (v[0].charAt(v[0].length - 2) === "/") {
            ...
            if ((w["æ•°æ®ç±»åž‹"] || w["value-type"]) == "string") {
              g.t = "s";
            ...
            H = [];
            V = {};
            g = { t: w["æ•°æ®ç±»åž‹"] || w["value-type"], v: null };
            if (w["style-name"] && M[w["style-name"]]) g.z = M[w["style-name"]];
            if (a.cellFormula) {
              ...
              if (w.formula) g.f = Us(w.formula);
                ...
                for (Z = 0; Z < z.length; ++Z)
                  if (T >= z[Z][0].s.r && T <= z[Z][0].e.r)
                    if (E >= z[Z][0].s.c && E <= z[Z][0].e.c) g.F = z[Z][1];
            }
            ...
            if (w["number-columns-repeated"])
              U = parseInt(w["number-columns-repeated"], 10);
            switch (g.t) {
              case "boolean":
                g.t = "b";
              ...
              if (!(a.sheetRows && a.sheetRows <= T)) {
                for (var q = 0; q < B; ++q) {
                  ...
                  if (a.dense) {
                    ...
                    m[$a({ r: T + q, c: E })] = g;
                    while (--U > 0) m[$a({ r: T + q, c: E + U })] = yr(g);
                  }
                  if (F.e.c <= E) F.e.c = E;
                }
              }
        ...
        case "style":
          {
            var re = rt(v[0], false);
            if (re["family"] == "table-cell" && O[re["data-style-name"]])
              M[re["name"]] = O[re["data-style-name"]];
          }
          break;
        case "map":
          break;
        ...
        case "named-range":
          ...
          var te = { Name: l.name, Ref: j[0] + "!" + j[1] };
        ...
        case "a":
          if (v[1] !== "/") {
            ...
            if (W.Target.charAt(0) == "#" && W.Target.indexOf(".") > -1) {
              ...
              W.Target = "#" + j[0] + "!" + j[1];
            } else if (W.Target.match(/^\.\.[\\\/]/))
              W.Target = W.Target.slice(3);
          }
          break;
    ...
    var ie = { Sheets: d, SheetNames: p, Workbook: $ };
    ...
    e: {
      ...
      if (["y", "m", "d"].indexOf(e[0]) > -1) {
        ...
        r: for (; s < e.length; ++s)
          switch ((i = e[s].toLowerCase())) {
            ...
            case "y":
            case "d":
              while ((e[++s] || "").toLowerCase() == i[0]) i += i[0];
              --s;
              switch (i) {
                case "y":
                case "yy":
            ...
            default:
              console.error(
                "unrecognized character " + i + " in ODF format " + e,
              );
          }
        if (!o) break e;
        e = e.slice(s + 1);
      ...
      if (!f || !f[0]) console.error("Could not find numeric part of " + e);
        ...
        a +=
          ...
          (u.indexOf("0") == -1 ? "0" : u.length - u.indexOf("0")) +
          '"' +
          (f[0].indexOf(",") > -1 ? ' number:grouping="true"' : "") +
          ((f[2] && ' number:decimal-places="' + (f[2].length - 1) + '"') ||
            ' number:decimal-places="0"') +
          (f[3] && f[3].indexOf("+") > -1
            ? ' number:forced-exponent-sign="true"'
            : "") +
          (f[3]
            ? ' number:min-exponent-digits="' + f[3].match(/0+/)[0].length + '"'
            : "") +
          ">" +
          "</number:" +
          (f[3] ? "scientific-" : "") +
  ...
  var To = (function () {
    ...
    var t = function (t, a, n, i, s, l) {
      ...
      if (t["!cols"]) {
        for (f = 0; f <= u.e.c; ++f)
          o.push(
            "        <table:table-column" +
              (t["!cols"][f]
                ? ' table:style-name="co' + t["!cols"][f].ods + '"'
                : "") +
              "></table:table-column>\n",
          );
      }
      var m = "",
        v = t["!rows"] || [];
      for (c = 0; c < u.s.r; ++c) {
        m = v[c] ? ' table:style-name="ro' + v[c].ods + '"' : "";
        o.push("        <table:table-row" + m + "></table:table-row>\n");
      }
      for (; c <= u.e.r; ++c) {
        m = v[c] ? ' table:style-name="ro' + v[c].ods + '"' : "";
        o.push("        <table:table-row" + m + ">\n");
        for (f = 0; f < u.s.c; ++f) o.push(r);
        for (; f <= u.e.c; ++f) {
          var g = false,
            b = {},
            w = "";
          for (d = 0; d != h.length; ++d) {
            if (h[d].s.c > f) continue;
            if (h[d].s.r > c) continue;
            if (h[d].e.c < f) continue;
            if (h[d].e.r < c) continue;
            if (h[d].s.c != f || h[d].s.r != c) g = true;
            b["table:number-columns-spanned"] = h[d].e.c - h[d].s.c + 1;
            b["table:number-rows-spanned"] = h[d].e.r - h[d].s.r + 1;
            break;
          }
          if (g) {
          ...
          var k = $a({ r: c, c: f }),
            y = p ? (t["!data"][c] || [])[f] : t[k];
          if (y && y.f) {
            b["table:formula"] = ot(zs(y.f));
            if (y.F) {
              if (y.F.slice(0, k.length) == k) {
                var x = Wa(y.F);
                b["table:number-matrix-columns-spanned"] = x.e.c - x.s.c + 1;
                b["table:number-matrix-rows-spanned"] = x.e.r - x.s.r + 1;
              }
            }
          }
          if (!y) {
          ...
          switch (y.t) {
            case "b":
              w = y.v ? "TRUE" : "FALSE";
              b["office:value-type"] = "boolean";
              b["office:boolean-value"] = y.v ? "true" : "false";
              break;
            case "n":
              w = y.w || String(y.v || 0);
              b["office:value-type"] = "float";
              b["office:value"] = y.v || 0;
              break;
            case "s":
            case "str":
              w = y.v == null ? "" : y.v;
              ...
              break;
            case "d":
              w = y.w || wr(y.v, l).toISOString();
              b["office:value-type"] = "date";
              b["office:date-value"] = wr(y.v, l).toISOString();
              b["table:style-name"] = "ce1";
              break;
            default:
              o.push(r);
              continue;
          ...
          if (y.l && y.l.Target) {
            var C = y.l.Target;
            C = C.charAt(0) == "#" ? "#" + Ws(C.slice(1)) : C;
            if (C.charAt(0) != "#" && !C.match(/^\w+:/)) C = "../" + C;
            S = Ot("text:a", S, { "xlink:href": C.replace(/&/g, "&amp;") });
          }
          if (s[y.z]) b["table:style-name"] = "ce" + s[y.z].slice(1);
          var _ = Ot("text:p", S, {});
          if (y.c) {
            var A = "",
              T = "",
              E = {};
            for (var F = 0; F < y.c.length; ++F) {
              if (!A && y.c[F].a) A = y.c[F].a;
              T += "<text:p>" + e(y.c[F].t) + "</text:p>";
            }
            if (!y.c.hidden) E["office:display"] = true;
            _ = Ot("office:annotation", T, E) + _;
          }
          o.push("          " + Ot("table:table-cell", _, b) + "\n");
        }
        o.push("        </table:table-row>\n");
      }
      if ((a.Workbook || {}).Names)
        o.push(Ao(a.Workbook.Names, a.SheetNames, n));
      o.push("      </table:table>\n");
      return o.join("");
    };
    var a = function (e, r) {
      ...
      r.SheetNames.map(function (e) {
        ...
        for (var s = 0; s <= a.e.r; ++s)
          for (var l = 0; l <= a.e.c; ++l) {
            var o = t ? (r["!data"][s] || [])[l] : r[$a({ r: s, c: l })];
            if (!o || !o.z || o.z.toLowerCase() == "general") continue;
            if (!n[o.z]) {
              var c = _o(o.z, "N" + i);
              if (c) {
                n[o.z] = "N" + i;
    ...
    return function n(e, r) {
      ...
      for (var o = 0; o != e.SheetNames.length; ++o)
        n.push(
          t(
            e.Sheets[e.SheetNames[o]],
            e,
            o,
            r,
            l,
            ((e.Workbook || {}).WBProps || {}).date1904,
          ),
        );
      if ((e.Workbook || {}).Names)
        n.push(Ao(e.Workbook.Names, e.SheetNames, -1));
      n.push("    </office:spreadsheet>\n");
      n.push("  </office:body>\n");
  ...
  function Eo(e, r) {
    if (r.bookType == "fods") return To(e, r);
    var t = Vr();
    var a = "";
    var n = [];
    var i = [];
    a = "mimetype";
    Hr(t, a, "application/vnd.oasis.opendocument.spreadsheet");
    a = "content.xml";
    Hr(t, a, To(e, r));
    n.push([a, "text/xml"]);
  ...
  function Lo(e, r) {
    ...
    if (!Br(e, "[Content_Types].xml")) {
      ...
      if (a) {
        ...
        if (typeof Bun !== "undefined" && Buffer.isBuffer(a.content))
          return Jo(new Uint8Array(a.content), r);
    ...
    if (!r.bookSheets && !r.bookProps) {
      ...
      if (r.cellStyles && i.themes.length)
        c = is($r(e, i.themes[0].replace(/^\//, ""), true) || "", r);
    ...
    if (r.bookDeps && i.calcchain)
      g = ao(zr(e, Ro(i.calcchain)), i.calcchain, r);
    var b = 0;
    var w = {};
    var k, y;
    {
    ...
    var A = (
      i.workbooks[0].slice(0, _ + 1) +
      "_rels/" +
      i.workbooks[0].slice(_ + 1) +
      ".rels"
    ).replace(/^\//, "");
      ...
      if (r && r.sheets != null)
        switch (typeof r.sheets) {
          case "number":
            ...
            break;
          case "string":
            if (d.SheetNames[b].toLowerCase() != r.sheets.toLowerCase())
              continue e;
            break;
          default:
            if (Array.isArray && Array.isArray(r.sheets)) {
              ...
              for (var O = 0; O != r.sheets.length; ++O) {
                ...
                if (
                  typeof r.sheets[O] == "string" &&
                  r.sheets[O].toLowerCase() == d.SheetNames[b].toLowerCase()
                )
                  D = 1;
              }
              if (!D) continue e;
    ...
    if (r && r.bookVBA) {
      ...
      else if (i.defaults && i.defaults.bin === Ss)
        v.vbaraw = zr(e, "xl/vbaProject.bin", true);
    }
  ...
  function Uo(e, r) {
    ...
    var s = "",
      l = 0;
    r.cellXfs = [];
    Js(r.cellXfs, {}, { revssf: { General: 0 } });
    if (!e.Props) e.Props = {};
    s = "docProps/core.xml";
    Hr(i, s, Hn(e.Props, r));
    n.coreprops.push(s);
    Mn(r.rels, 2, s, En.CORE_PROPS);
    s = "docProps/app.xml";
    ...
    Hr(i, s, Jn(e.Props, r));
    n.extprops.push(s);
    Mn(r.rels, 3, s, En.EXT_PROPS);
    if (e.Custprops !== e.Props && ir(e.Custprops || {}).length > 0) {
      s = "docProps/custom.xml";
      Hr(i, s, qn(e.Custprops, r));
      n.custprops.push(s);
      Mn(r.rels, 4, s, En.CUST_PROPS);
    }
    var f = ["SheetJ5"];
    r.tcid = 0;
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      switch (d) {
        ...
        default:
          ...
          Hr(i, s, write_ws_bin(l - 1, r, e, u));
          n.sheets.push(s);
          Mn(r.wbrels, -1, "worksheets/sheet" + l + "." + t, En.WS[0]);
      }
      if (h) {
        var p = h["!comments"];
        var m = false;
        ...
        if (p && p.length > 0) {
          ...
          if (g) {
            v = "xl/threadedComments/threadedComment" + l + ".xml";
            Hr(i, v, ks(p, f, r));
            n.threadedcomments.push(v);
            Mn(
              u,
              -1,
              "../threadedComments/threadedComment" + l + ".xml",
              En.TCMNT,
            );
          }
          v = "xl/comments" + l + "." + t;
          Hr(i, v, write_comments_bin(p, r));
          n.comments.push(v);
          Mn(u, -1, "../comments" + l + "." + t, En.CMNT);
          m = true;
        }
        if (h["!legacy"]) {
          if (m)
            Hr(i, "xl/drawings/vmlDrawing" + l + ".vml", ps(l, h["!comments"]));
        }
        delete h["!comments"];
        delete h["!legacy"];
      }
      if (u["!id"].rId1) Hr(i, Fn(s), On(u));
    }
    if (r.Strings != null && r.Strings.length > 0) {
      s = "xl/sharedStrings." + t;
      Hr(i, s, write_sst_bin(r.Strings, r));
      n.strs.push(s);
      Mn(r.wbrels, -1, "sharedStrings." + t, En.SST);
    }
    s = "xl/workbook." + t;
    Hr(i, s, write_wb_bin(e, r));
    n.workbooks.push(s);
    Mn(r.rels, 1, s, En.WB);
    ...
    Hr(i, s, b);
    n.themes.push(s);
    Mn(r.wbrels, -1, "theme/theme1.xml", En.THEME);
    s = "xl/styles." + t;
    Hr(i, s, write_sty_bin(e, r));
    n.styles.push(s);
    Mn(r.wbrels, -1, "styles." + t, En.STY);
    if (e.vbaraw && a) {
      s = "xl/vbaProject.bin";
      Hr(i, s, e.vbaraw);
      n.vba.push(s);
      Mn(r.wbrels, -1, "vbaProject.bin", En.VBA);
    }
    s = "xl/metadata." + t;
    Hr(i, s, write_xlmeta_bin());
    n.metadata.push(s);
    Mn(r.wbrels, -1, "metadata." + t, En.XLMETA);
    if (f.length > 1) {
      s = "xl/persons/person.xml";
      Hr(i, s, xs(f, r));
      n.people.push(s);
      Mn(r.wbrels, -1, "persons/person.xml", En.PEOPLE);
    }
    Hr(i, "[Content_Types].xml", Tn(n, r));
    Hr(i, "_rels/.rels", On(r.rels));
    Hr(i, "xl/_rels/workbook." + t + ".rels", On(r.wbrels));
    delete r.revssf;
    delete r.ssf;
    return i;
  }
  ...
  function Jo(e, r) {
    ...
    switch ((i = $o(n, t))[0]) {
      ...
      case 255:
        if (i[1] === 254) {
          return Xo(n, t);
        } else if (i[1] === 0 && i[2] === 2 && i[3] === 0)
          return WK_.to_workbook(n, t);
        break;
      case 0:
        if (i[1] === 0) {
    ...
    if (Qn.indexOf(i[0]) > -1 && i[2] <= 12 && i[3] <= 31)
      return ei.to_workbook(n, t);
    return Yo(e, n, t, s);
  }
  function Zo(e, r) {
  ...
  function Ko(e, r) {
    switch (r.type) {
      ...
      case "array":
        ...
        break;
      case "file":
        return ar(r.file, Qe.write(e, { type: _ ? "buffer" : "" }));
      case "string":
        throw new Error(
  ...
  function rc(e, r) {
    ...
    if (r.password && typeof encrypt_agile !== "undefined")
      return Ko(encrypt_agile(n, r.password), r);
  ...
  function ac(e, r, t) {
    ...
    switch (r.type) {
      ...
      case "buffer": {
        if (_) return A(a, "utf8");
        else if (typeof TextEncoder !== "undefined")
          return new TextEncoder().encode(a);
        else
          return ac(a, { type: "binary" })
            .split("")
            .map(function (e) {
  ...
  function ic(e, r) {
    switch (r.type) {
      ...
      case "binary":
        ...
        return r.type == "base64" ? y(t) : r.type == "string" ? kt(t) : t;
      case "file":
        return ar(r.file, e);
      case "buffer":
        return e;
  ...
  function lc(e, r) {
    ...
    switch (t.bookType || "xlsb") {
      case "xml":
      case "xlml":
        return ac(write_xlml(e, t), t);
      case "slk":
      case "sylk":
        return ac(ri.from_sheet(e.Sheets[e.SheetNames[n]], t, e), t);
      case "htm":
      case "html":
        return ac(ho(e.Sheets[e.SheetNames[n]], t), t);
      case "txt":
        return nc(gc(e.Sheets[e.SheetNames[n]], t), t);
      case "csv":
        return ac(vc(e.Sheets[e.SheetNames[n]], t), t, "\ufeff");
      case "dif":
        return ac(ti.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "dbf":
        return ic(ei.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "prn":
        return ac(ni.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "rtf":
        return ac(sheet_to_rtf(e.Sheets[e.SheetNames[n]], t), t);
      case "eth":
        return ac(ai.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "fods":
        return ac(Eo(e, t), t);
      case "wk1":
        return ic(WK_.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t);
      case "wk3":
        return ic(WK_.book_to_wk3(e, t), t);
      case "biff2":
        if (!t.biff) t.biff = 2;
      case "biff3":
        if (!t.biff) t.biff = 3;
      case "biff4":
        if (!t.biff) t.biff = 4;
        return ic(write_biff_buf(e, t), t);
      case "biff5":
        if (!t.biff) t.biff = 5;
      case "biff8":
      case "xla":
  ...
  function uc(e, r, t, a) {
    ...
    return er.writeFile(e, lc(r, n), i);
  }
      ...
      for (var p = r.s.c; p <= r.e.c; ++p) {
        ...
        if (i[p] != null) {
          if (v == null) {
            ...
            h[i[p]] = (
              m.t === "n" && typeof s.rawNumbers === "boolean"
                ? s.rawNumbers
                : c
            )
              ? v
  ...
  function dc(e, r) {
    ...
    for (g = o.s.r + n; g <= o.e.r; ++g) {
      ...
      if (
        x.isempty === false ||
        (a === 1 ? c.blankrows !== false : !!c.blankrows)
      )
        d[p++] = x.row;
    }
    d.length = p;
  ...
  function wc(e, r, t) {
    ...
    var f = { s: { c: 0, r: 0 }, e: { c: o, r: l + r.length - 1 + i } };
    if (s["!ref"]) {
      var u = Xa(s["!ref"]);
      f.e.c = Math.max(f.e.c, u.e.c);
      f.e.r = Math.max(f.e.r, u.e.r);
    ...
    if (i)
      for (d = 0; d < h.length; ++d) {
        if (n) s["!data"][l][d + o] = { t: "s", v: h[d] };
        else s[Ra(d + o) + m] = { t: "s", v: h[d] };
      }
    s["!ref"] = ja(f);
    return s;
  }
  ...
  function yc(e, r, t) {
    if (typeof r == "string") {
      if (e["!data"] != null) {
        ...
        return e["!data"][a.r][a.c] || (e["!data"][a.r][a.c] = { t: "z" });
      }
      return e[r] || (e[r] = { t: "z" });
    }
