...
- 🏛️ **preTax Reports (Accounting):** Generates a specialized .xlsx file structured for real legal tax processes. It supports over 20+ fiat currencies (USD, EUR, PLN, etc.) and includes a current-moment 'Stocktaking' sheet (requires manual adjustment for items where a buy transaction wasn't found)
